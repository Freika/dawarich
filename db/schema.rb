...
ActiveRecord::Schema[8.0].define(version: 20_260_201_000_002) do
...
unique: true
  ...
  create_table 'points', force: :cascade do |t|
    ...
    t.index %w[user_id city], name: 'idx_points_user_city'
    ...
    t.index %w[user_id reverse_geocoded_at], name: 'index_points_on_user_id_and_reverse_geocoded_at',
