...
INSERT INTO users (email, created_at, updated_at, visits_redetected_at) VALUES ('disabled-one@example.test', '2026-01-01 00:00:00', '2026-01-01 00:00:00', '2026-01-01 00:00:00');
INSERT INTO users (email, created_at, updated_at, visits_redetected_at) VALUES ('disabled-two@example.test', '2026-01-01 00:00:00', '2026-01-01 00:00:00', '2026-01-01 00:00:00');
INSERT INTO service_settings (user_id, service, provider, config, credentials, active, created_at, updated_at)
  SELECT id, 0, 'nominatim', '{"host": "nominatim.example.test", "use_https": true}', NULL, false, '2026-01-01 00:00:00', '2026-01-01 00:00:00' FROM users WHERE email = 'disabled-one@example.test';
