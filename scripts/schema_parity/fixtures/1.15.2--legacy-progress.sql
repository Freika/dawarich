...
INSERT INTO users (email, created_at, updated_at, visits_redetected_at) VALUES ('explorer@example.test', '2026-01-01 00:00:00', '2026-01-01 00:00:00', '2026-01-01 00:00:00');
INSERT INTO achievement_progresses (user_id, achievement_key, state, created_at, updated_at)
  SELECT id, 'explorer_germany', '{"earned": {"DE-BE": "2026-01-02T00:00:00Z"}}', '2026-01-01 00:00:00', '2026-01-01 00:00:00'
  FROM users WHERE email = 'explorer@example.test';
