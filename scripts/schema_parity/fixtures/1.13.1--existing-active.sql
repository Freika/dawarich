...
INSERT INTO users (email, created_at, updated_at, visits_redetected_at) VALUES ('configured@example.test', '2026-01-01 00:00:00', '2026-01-01 00:00:00', '2026-01-01 00:00:00');
INSERT INTO users (email, created_at, updated_at, visits_redetected_at) VALUES ('fresh@example.test', '2026-01-01 00:00:00', '2026-01-01 00:00:00', '2026-01-01 00:00:00');
INSERT INTO users (email, created_at, updated_at, visits_redetected_at, deleted_at) VALUES ('gone@example.test', '2026-01-01 00:00:00', '2026-01-01 00:00:00', '2026-01-01 00:00:00', '2026-01-01 00:00:00');
INSERT INTO service_settings (user_id, service, provider, config, credentials, active, created_at, updated_at)
  SELECT id, 0, 'nominatim', '{"host": "nominatim.local", "use_https": false}', '{"p":"ClcHqXCRawy9KJDT/ckGPQNTx6EdAEotSL2olgIjX7KOpqyAxw==","h":{"iv":"FsvY5Drim8MD9eWL","at":"0Ac6CBSb7rCXO1U1tFSyyg=="}}', true, '2026-01-01 00:00:00', '2026-01-01 00:00:00' FROM users WHERE email = 'configured@example.test';
