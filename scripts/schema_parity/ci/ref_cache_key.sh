...
code="$(code_key)"
cd "$root"
find db/schema.rb db/release_snapshots scripts/schema_parity/fixtures scripts/schema_parity/ecto_expectations.tsv -type f \
  ! -path db/release_snapshots/README.md > "$tmpd/found"
