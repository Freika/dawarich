...
export class DataLoader {
  ...
  /**
   * Fetch all map data (points, visits, photos, Places, tracks)
   * Core data (points, visits, Places) loads incrementally.
  ...
  async fetchMapData(
    ...
    const [pointsResult, visits, places, flights] = await Promise.all([
      pointsPromise,
      visitsPromise,
      placesPromise,
      flightsPromise,
