...
- Every detected visit carries a confidence score. Medium-confidence visits render subdued on the timeline, low-confidence ones collapse into a per-day "N low-confidence stops" disclosure, and anything you confirm always renders at full strength.
