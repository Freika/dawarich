        ...
        schema type: :array,
               items: {
                 ...
                 properties: {
                   ...
                   velocity: { type: :string, nullable: true, description: 'Velocity in km/h, serialized as a string' },
                   ...
                   country_name: { type: :string, description: 'Reverse-geocoded country name, empty when unknown' },
